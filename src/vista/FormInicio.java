...
public class FormInicio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtJugador1.setBackground(new java.awt.Color(214, 242, 249));
        txtJugador1.setFont(new java.awt.Font("Helvetica Neue", 1, 28)); // NOI18N
        ...
        txtJugador2.setFont(new java.awt.Font("Helvetica Neue", 1, 28)); // NOI18N
        ...
        lblIniciar.setFont(new java.awt.Font("Helvetica Neue", 1, 20)); // NOI18N
    ...
    private void lblIniciarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblIniciarMousePressed
        ...
        else jugador1.setNombre(txtJugador1.getText());
        
        Jugador jugador2 = new Jugador(TipoImagen.CIRCULO);
        if(txtJugador2.getText().equals(""))
            jugador2.setNombre("JUGADOR2");
        else jugador2.setNombre(txtJugador2.getText());
                
       
        
        Form3EnRaya form3EnRaya = new Form3EnRaya(jugador1, jugador2);
        form3EnRaya.setVisible(true);
